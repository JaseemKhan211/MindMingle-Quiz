...
var login = exports.login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(usrid, pw) {
    var res, data;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          console.log("Attempting to log in with usrid: ".concat(usrid, " and pw: ").concat(pw));
          _context.prev = 1;
          _context.next = 4;
        ...
        case 10:
          ...
          if (_context.t0.response) {
            console.log('Error response:', _context.t0.response); // Log the error response
            (0, _alerts.showAlert)('error', _context.t0.response.data.message);
          } else {
            console.error('Error:', _context.t0);
            (0, _alerts.showAlert)('error', 'An unexpected error occurred.');
          }
        case 13:
        case "end":
